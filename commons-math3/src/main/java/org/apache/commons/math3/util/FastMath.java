...
public class FastMath {
	...
	public static double cosh(double x) {
		...
		Double excResult = processLargeNumberCosh(x);
		if (excResult != null)
			return excResult;
	...
	private static Double processLargeNumberHyperbolic(double x, Supplier<Double> arg8) {
		if (x > 20) {
			if (x >= LOG_MAX_VALUE) {
	...
	public static double sinh(double x) {
		...
		Double excResult = processLargeNumberSinh(x);
		if (excResult != null)
			return excResult;
